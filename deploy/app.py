...
# Load models
model_rf_gscv = joblib.load(os.path.join(MODELS_FOLDER, 'random_forest_model_GridSearchCV.pkl'))
model_rf_rscv = joblib.load(os.path.join(MODELS_FOLDER, 'random_forest_model_RandomizedSearchCV.pkl'))
model_xgb = joblib.load(os.path.join(MODELS_FOLDER, 'xgboost_model.pkl'))
